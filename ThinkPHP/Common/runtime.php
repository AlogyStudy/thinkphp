...
if(version_compare(PHP_VERSION,'5.4.0','<')) {
    ...
    define('MAGIC_QUOTES_GPC',get_magic_quotes_gpc()?True:False); // 设置URL转义符号
}else{
    define('MAGIC_QUOTES_GPC',false);
}
define('IS_CGI',substr(PHP_SAPI, 0,3)=='cgi' ? 1 : 0 ); // 定义是否是通用网关接口
define('IS_WIN',strstr(PHP_OS, 'WIN') ? 1 : 0 ); // 判断系统 
define('IS_CLI',PHP_SAPI=='cli'? 1   :   0); // 运行模式，
