...
insert into sw_auth values (null,'商品管理',0,'','','1', 0);
insert into sw_auth values (null,'商品列表',1,'Goods','showlist','1-2', 1);
insert into sw_auth values (null,'添加商品',1,'Goods','add','1-3', 1);
insert into sw_auth values (null,'用户评论',1,'User','pinglun','1-4', 1);

insert into sw_auth values (null,'订单管理',0,'','','5', 0);
insert into sw_auth values (null,'订单列表',5,'Order','showlist','5-6', 1);
insert into sw_auth values (null,'订单查询',5,'Order','view','5-7', 1);

insert into sw_auth values (null,'文章管理',0,'','','8', 0);
insert into sw_auth values (null,'文章列表',8,'Article','showlist','8-9', 1);

insert into sw_auth values (null,'权限管理',0,'','','10', 0);
insert into sw_auth values (null,'管理员列表',10,'Manager','showlist','10-11', 1);
insert into sw_auth values (null,'角色管理',10,'Role','showlist','10-12', 1);
insert into sw_auth values (null,'权限管理',10,'Auth','showlist','10-13', 1);
